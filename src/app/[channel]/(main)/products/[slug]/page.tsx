...
export default async function Page({
	...
	return (
		<section className="mx-auto grid max-w-7xl p-8 pt-16">
			<script
				...
				<div className="flex flex-col pt-6 sm:col-span-1 sm:px-6 sm:pt-0 lg:col-span-3 lg:pt-16">
					<div>
						...
						<div className="mt-8 space-y-4 text-sm text-neutral-500">
							<div dangerouslySetInnerHTML={{ __html: xss("Berat: 10000 G") }} />
							<div dangerouslySetInnerHTML={{ __html: xss("Dimensi: 25 X 100 X 102 CM") }} />
							<div dangerouslySetInnerHTML={{ __html: xss("Warna: Biru Navy") }} />
						</div>
						<AvailabilityMessage isAvailable={isAvailable} />
						<div className="mt-8 flex justify-center gap-10">
							{/* <AddButton disabled={!selectedVariantID || !selectedVariant?.quantityAvailable} /> */}
							<Button
								label="Masuk ke keranjang"
								type="button"
								variant="primary"
								className="px-[1.2rem] text-sm md:px-8"
							/>
							<Button
								label="Beli langsung"
								type="button"
						...
						<div className="mt-8 space-y-1 text-sm text-neutral-500">
							<div
								dangerouslySetInnerHTML={{
									__html: xss("Ingin Mendekor Dengan Gambar 3D, Pakai Layanan Room Planner Kami"),
								}}
							/>
						</div>
						<div className="mt-8">
